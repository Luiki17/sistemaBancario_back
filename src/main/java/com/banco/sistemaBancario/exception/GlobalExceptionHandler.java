...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleCuentaNoEncontradaException(CuentaNoEncontradaException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", ex.getMessage());
    ...
    public ResponseEntity<?> handleTransferenciaInvalidaException(TransferenciaInvalidaException ex) {
        Map<String, String> error = new HashMap<>();
        error.put("error", ex.getMessage());
        return new ResponseEntity<>(error, HttpStatus.BAD_REQUEST);
    }
